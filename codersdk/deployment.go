...
const (
	...
	ExperimentClaudeCodeChats       Experiment = "claude-code-chats"       // Enables running agent chats on the Claude Code runtime.
)
...
func (e Experiment) DisplayName() string {
	...
	case ExperimentClaudeCodeChats:
		return "Claude Code Chats"
	default:
