...
type RecordModelThoughtRequest struct {
	...
	Metadata       map[string]*anypb.Any  `protobuf:"bytes,3,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *IsAuthorizedRequest) Reset() {
	*x = IsAuthorizedRequest{}
	mi := &file_enterprise_aibridged_proto_aibridged_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IsAuthorizedRequest) Descriptor() ([]byte, []int) {
	return file_enterprise_aibridged_proto_aibridged_proto_rawDescGZIP(), []int{17}
}
...
func (x *IsAuthorizedResponse) Reset() {
	*x = IsAuthorizedResponse{}
	mi := &file_enterprise_aibridged_proto_aibridged_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IsAuthorizedResponse) Descriptor() ([]byte, []int) {
	return file_enterprise_aibridged_proto_aibridged_proto_rawDescGZIP(), []int{18}
}
...
const file_enterprise_aibridged_proto_aibridged_proto_rawDesc = "" +
	"\n" +
	"*enterprise/aibridged/proto/aibridged.proto\x12\x05proto\x1a\x19google/protobuf/any.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc8\x05\n" +
	...
	"\n" +
	"api_key_id\x18\a \x01(\tR\bapiKeyId\x12\x16\n" +
	"\x06client\x18\b \x01(\tR\x06client\x12\x1d\n" +
	"\n" +
	"user_agent\x18\t \x01(\tR\tuserAgent\x12<\n" +
	"\x18correlating_tool_call_id\x18\n" +
	" \x01(\tH\x00R\x15correlatingToolCallId\x88\x01\x01\x12/\n" +
	"\x11client_session_id\x18\v \x01(\tH\x01R\x0fclientSessionId\x88\x01\x01\x12#\n" +
	"\rprovider_name\x18\f \x01(\tR\fproviderName\x12'\n" +
	"\x0fcredential_kind\x18\r \x01(\tR\x0ecredentialKind\x12'\n" +
	"\x0fcredential_hint\x18\x0e \x01(\tR\x0ecredentialHint\x1aQ\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01B\x1b\n" +
	"\x19_correlating_tool_call_idB\x14\n" +
	"\x12_client_session_id\"\x1c\n" +
	...
	"\x1fRecordInterceptionEndedResponse\"\xe9\x03\n" +
	...
	"\x17cache_read_input_tokens\x18\a \x01(\x03R\x14cacheReadInputTokens\x127\n" +
	"\x18cache_write_input_tokens\x18\b \x01(\x03R\x15cacheWriteInputTokens\x1aQ\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	...
	"\x19RecordPromptUsageResponse\"\x8f\x04\n" +
	...
	"\x17RecordToolUsageResponse\"\xb8\x02\n" +
	"\x19RecordModelThoughtRequest\x12'\n" +
	"\x0finterception_id\x18\x01 \x01(\tR\x0einterceptionId\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x12J\n" +
	"\bmetadata\x18\x03 \x03(\v2..proto.RecordModelThoughtRequest.MetadataEntryR\bmetadata\x129\n" +
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x1aQ\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01\"\x1c\n" +
	"\x1aRecordModelThoughtResponse\"5\n" +
	...
	"\x0fRecordToolUsage\x12\x1d.proto.RecordToolUsageRequest\x1a\x1e.proto.RecordToolUsageResponse\x12Y\n" +
	"\x12RecordModelThought\x12 .proto.RecordModelThoughtRequest\x1a!.proto.RecordModelThoughtResponse2\xeb\x01\n" +
...
var file_enterprise_aibridged_proto_aibridged_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_enterprise_aibridged_proto_aibridged_proto_goTypes = []any{
	...
	nil,                                           // 19: proto.RecordInterceptionRequest.MetadataEntry
	nil,                                           // 20: proto.RecordTokenUsageRequest.MetadataEntry
	nil,                                           // 21: proto.RecordPromptUsageRequest.MetadataEntry
	nil,                                           // 22: proto.RecordToolUsageRequest.MetadataEntry
	nil,                                           // 23: proto.RecordModelThoughtRequest.MetadataEntry
	nil,                                           // 24: proto.GetMCPServerAccessTokensBatchResponse.AccessTokensEntry
	nil,                                           // 25: proto.GetMCPServerAccessTokensBatchResponse.ErrorsEntry
	(*timestamppb.Timestamp)(nil),                 // 26: google.protobuf.Timestamp
	(*anypb.Any)(nil),                             // 27: google.protobuf.Any
}
var file_enterprise_aibridged_proto_aibridged_proto_depIdxs = []int32{
	19, // 0: proto.RecordInterceptionRequest.metadata:type_name -> proto.RecordInterceptionRequest.MetadataEntry
	26, // 1: proto.RecordInterceptionRequest.started_at:type_name -> google.protobuf.Timestamp
	26, // 2: proto.RecordInterceptionEndedRequest.ended_at:type_name -> google.protobuf.Timestamp
	20, // 3: proto.RecordTokenUsageRequest.metadata:type_name -> proto.RecordTokenUsageRequest.MetadataEntry
	26, // 4: proto.RecordTokenUsageRequest.created_at:type_name -> google.protobuf.Timestamp
	21, // 5: proto.RecordPromptUsageRequest.metadata:type_name -> proto.RecordPromptUsageRequest.MetadataEntry
	26, // 6: proto.RecordPromptUsageRequest.created_at:type_name -> google.protobuf.Timestamp
	22, // 7: proto.RecordToolUsageRequest.metadata:type_name -> proto.RecordToolUsageRequest.MetadataEntry
	26, // 8: proto.RecordToolUsageRequest.created_at:type_name -> google.protobuf.Timestamp
	23, // 9: proto.RecordModelThoughtRequest.metadata:type_name -> proto.RecordModelThoughtRequest.MetadataEntry
	26, // 10: proto.RecordModelThoughtRequest.created_at:type_name -> google.protobuf.Timestamp
	...
	24, // 13: proto.GetMCPServerAccessTokensBatchResponse.access_tokens:type_name -> proto.GetMCPServerAccessTokensBatchResponse.AccessTokensEntry
	25, // 14: proto.GetMCPServerAccessTokensBatchResponse.errors:type_name -> proto.GetMCPServerAccessTokensBatchResponse.ErrorsEntry
	27, // 15: proto.RecordInterceptionRequest.MetadataEntry.value:type_name -> google.protobuf.Any
	27, // 16: proto.RecordTokenUsageRequest.MetadataEntry.value:type_name -> google.protobuf.Any
	27, // 17: proto.RecordPromptUsageRequest.MetadataEntry.value:type_name -> google.protobuf.Any
	27, // 18: proto.RecordToolUsageRequest.MetadataEntry.value:type_name -> google.protobuf.Any
	27, // 19: proto.RecordModelThoughtRequest.MetadataEntry.value:type_name -> google.protobuf.Any
	0,  // 20: proto.Recorder.RecordInterception:input_type -> proto.RecordInterceptionRequest
	2,  // 21: proto.Recorder.RecordInterceptionEnded:input_type -> proto.RecordInterceptionEndedRequest
	4,  // 22: proto.Recorder.RecordTokenUsage:input_type -> proto.RecordTokenUsageRequest
	6,  // 23: proto.Recorder.RecordPromptUsage:input_type -> proto.RecordPromptUsageRequest
	8,  // 24: proto.Recorder.RecordToolUsage:input_type -> proto.RecordToolUsageRequest
	10, // 25: proto.Recorder.RecordModelThought:input_type -> proto.RecordModelThoughtRequest
	12, // 26: proto.MCPConfigurator.GetMCPServerConfigs:input_type -> proto.GetMCPServerConfigsRequest
	15, // 27: proto.MCPConfigurator.GetMCPServerAccessTokensBatch:input_type -> proto.GetMCPServerAccessTokensBatchRequest
	17, // 28: proto.Authorizer.IsAuthorized:input_type -> proto.IsAuthorizedRequest
	1,  // 29: proto.Recorder.RecordInterception:output_type -> proto.RecordInterceptionResponse
	3,  // 30: proto.Recorder.RecordInterceptionEnded:output_type -> proto.RecordInterceptionEndedResponse
	5,  // 31: proto.Recorder.RecordTokenUsage:output_type -> proto.RecordTokenUsageResponse
	7,  // 32: proto.Recorder.RecordPromptUsage:output_type -> proto.RecordPromptUsageResponse
	9,  // 33: proto.Recorder.RecordToolUsage:output_type -> proto.RecordToolUsageResponse
	11, // 34: proto.Recorder.RecordModelThought:output_type -> proto.RecordModelThoughtResponse
	13, // 35: proto.MCPConfigurator.GetMCPServerConfigs:output_type -> proto.GetMCPServerConfigsResponse
	16, // 36: proto.MCPConfigurator.GetMCPServerAccessTokensBatch:output_type -> proto.GetMCPServerAccessTokensBatchResponse
	18, // 37: proto.Authorizer.IsAuthorized:output_type -> proto.IsAuthorizedResponse
...
func file_enterprise_aibridged_proto_aibridged_proto_init() {
	...
	file_enterprise_aibridged_proto_aibridged_proto_msgTypes[0].OneofWrappers = []any{}
