...
CREATE TABLE external_auth_provider_configs (
    ...
    revoke_url text DEFAULT ''::text NOT NULL,
    device_code_url text DEFAULT ''::text NOT NULL,
    scopes text[] DEFAULT '{}'::text[] NOT NULL,
    extra_token_keys text[] DEFAULT '{}'::text[] NOT NULL,
    no_refresh boolean DEFAULT false NOT NULL,
    device_flow boolean DEFAULT false NOT NULL,
    regex text DEFAULT ''::text NOT NULL,
    app_install_url text DEFAULT ''::text NOT NULL,
    app_installations_url text DEFAULT ''::text NOT NULL,
    code_challenge_methods text[] DEFAULT '{S256}'::text[] NOT NULL,
...
ALTER TABLE ONLY external_auth_provider_configs
    ADD CONSTRAINT external_auth_provider_configs_pkey PRIMARY KEY (id);

ALTER TABLE ONLY external_auth_provider_configs
    ADD CONSTRAINT external_auth_provider_configs_provider_id_key UNIQUE (provider_id);
...
ALTER TABLE ONLY external_auth_provider_configs
    ADD CONSTRAINT external_auth_provider_configs_client_secret_key_id_fkey FOREIGN KEY (client_secret_key_id) REFERENCES dbcrypt_keys(active_key_digest);
