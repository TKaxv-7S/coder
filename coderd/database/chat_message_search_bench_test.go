...
//
// The COALESCE to an empty tsvector in the sweep UPDATE is a sentinel: rows whose
...
// of unswept searchable rows and store their tsvector, using an empty tsvector
// as a processed sentinel for rows with no extractable text.
