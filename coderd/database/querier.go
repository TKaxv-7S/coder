...
type sqlcQuerier interface {
	...
	GetExternalAuthProviderConfigByID(ctx context.Context, id uuid.UUID) (ExternalAuthProviderConfig, error)
	GetExternalAuthProviderConfigByProviderID(ctx context.Context, providerID string) (ExternalAuthProviderConfig, error)
	GetExternalAuthProviderConfigs(ctx context.Context) ([]ExternalAuthProviderConfig, error)
	...
	InsertExternalAuthProviderConfig(ctx context.Context, arg InsertExternalAuthProviderConfigParams) (ExternalAuthProviderConfig, error)
	...
	UpdateExternalAuthProviderConfig(ctx context.Context, arg UpdateExternalAuthProviderConfigParams) (ExternalAuthProviderConfig, error)
	...
	UpsertExternalAuthProviderConfigFromEnv(ctx context.Context, arg UpsertExternalAuthProviderConfigFromEnvParams) (ExternalAuthProviderConfig, error)
