...
interface ConfigureProviderStepProps {
	onComplete: () => void;
	onSkip: () => void;
...
export const ConfigureProviderStep: FC<ConfigureProviderStepProps> = ({
	onComplete,
	onSkip,
				...
				<div className="flex flex-col gap-4">
					...
					{createProvider.error && (
						<p className="text-sm text-content-destructive m-0">
							Failed to save provider. Please check your credentials and try
							again.
						</p>
					)}
					...
					<div className="flex justify-between items-center pt-2">
						...
						<Button
							disabled={!apiKey || createProvider.isPending}
							onClick={handleSave}
						>
							<Spinner loading={createProvider.isPending} />
							Save &amp; Continue
						</Button>
					</div>
				</div>
