...
const file_provisionersdk_proto_provisioner_proto_rawDesc = "" +
	...
	"\x16port_forwarding_helper\x18\x05 \x01(\bR\x14portForwardingHelper\"V\n" +
	"\x03Env\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12%\n" +
	"\x0emerge_strategy\x18\x03 \x01(\tR\rmergeStrategy\"\x9f\x02\n" +
	"\x06Script\x12!\n" +
	...
	"\x11module_files_hash\x18\x05 \x01(\fR\x0fmoduleFilesHash\"\xae\x03\n" +
	"\vPlanRequest\x121\n" +
	...
	"\x05state\x18\x06 \x01(\fR\x05stateJ\x04\b\a\x10\b\"\x80\x02\n" +
