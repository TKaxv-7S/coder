...
var auditableResourcesTypes = map[any]map[string]Action{
	...
	&database.ExternalAuthProviderConfig{}: {
		...
		"type":                    ActionTrack,
		"display_name":            ActionTrack,
		"display_icon":            ActionTrack,
		"client_id":               ActionTrack,
		"client_secret_encrypted": ActionSecret,
		"client_secret_key_id":    ActionIgnore,
		"auth_url":                ActionTrack,
		"token_url":               ActionTrack,
		"validate_url":            ActionTrack,
		"revoke_url":              ActionTrack,
		"device_code_url":         ActionTrack,
		"scopes":                  ActionTrack,
		"extra_token_keys":        ActionTrack,
		"no_refresh":              ActionTrack,
		"device_flow":             ActionTrack,
		"regex":                   ActionTrack,
		"app_install_url":         ActionTrack,
		"app_installations_url":   ActionTrack,
		"code_challenge_methods":  ActionTrack,
		"source":                  ActionTrack,
	},
}
