...
| `labels`           | object                                         | false    |              |                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| » `[any property]` | string                                         | false    |              |                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `mcp_server_ids`   | array of string                                | false    |              | Mcp server ids replaces the chat's selected MCP servers. nil: no change, empty slice: clear the selection. Servers with force_on availability remain active regardless of this list. Changes apply from the next generation step, including mid-turn while the chat waits on tool results.                                                                                                                                              |
